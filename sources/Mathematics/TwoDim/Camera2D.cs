...
public sealed class Camera2D {
	...
	public static Camera2D Normal(Camera2D camera) {
	...
	public static Camera2D Resolved(Camera2D camera, bool onlyInt = false, float fixedResolution = -1.0F) {
		Vector2 size = RenderSystem.GetWindow().Size;
	...
	public static Camera2D World(Camera2D camera, in Vector2 center, float horiSight) {
		Vector2 size = RenderSystem.GetWindow().Size;
