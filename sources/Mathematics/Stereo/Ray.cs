...
public readonly struct Ray {
	...
	public static Ray CreateFromPoints(in Vector3 from, in Vector3 to) {
	...
	public static Ray CreateFromScreen(float screenX, float screenY, float screenWidth,
		float screenHeight,
	...
	public Ray Reflect(in Vector3 normal, in Vector3 point) {
		Vector3 reflectedDir = Direction.Reflect(normal);
		return new Ray(point, reflectedDir);
	}
	...
	public Ray? Refract(in Vector3 normal, in Vector3 point, float ior) {
	...
	public static Ray Lerp(in Ray a, in Ray b, float t) {
